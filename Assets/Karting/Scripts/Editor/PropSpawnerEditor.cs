...
public class PropSpawnerEditor : Editor
{
    ...
    public void OnEnable()
    {
        ...
        _VisualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Karting/Scripts/Editor/PropSpawnerTemplate.uxml");
        
        //Load the style
        StyleSheet stylesheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Karting/Scripts/Editor/PropSpawnerStyles.uss");
    ...
    public void AddButtonIcon(VisualElement button)
    {
        IMGUIContainer icon = new IMGUIContainer(() =>
        {
            ...
            string path = "Assets/Karting/Prefabs/LevelEditor" + button.name + ".prefab";
            ...
            editor.OnPreviewGUI(GUILayoutUtility.GetRect(90, 90), EditorStyles.whiteLabel);
        });
    ...
    {
        string path = "Assets/Karting/Prefabs/LevelEditor" + prefabToSpawn + ".prefab";
